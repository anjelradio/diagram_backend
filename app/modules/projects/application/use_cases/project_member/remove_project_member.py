...
class RemoveProjectMemberCommand:
    """Comando para remover un colaborador de un proyecto."""
...
class RemoveProjectMemberUseCase:
    """Caso de uso para que el propietario remueva a un colaborador."""
    ...
    def execute(self, command: RemoveProjectMemberCommand) -> None:
