...
class PromoteProjectMemberCommand:
    """Comando para promover un colaborador a rol EDITOR."""
...
class PromoteProjectMemberUseCase:
    """Caso de uso para que el propietario promueva a un colaborador a EDITOR."""
    ...
    def execute(self, command: PromoteProjectMemberCommand) -> None:
